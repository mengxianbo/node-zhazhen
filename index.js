...
const UUID = process.env.UUID || 'c9bd5a19-1719-4198-95d9-eb1a8734cfce'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'ybFCIq4cy06A3bnQ8viBOavIGenG4VQy';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'desvip.jianxian.nyc.mn';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
...
const SUB_PATH = process.env.SUB_PATH || 'jianxianapp';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'freePanel';                       // 节点名称
const PORT = process.env.PORT || 6063;                     // http和ws服务端口
